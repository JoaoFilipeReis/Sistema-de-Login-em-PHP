        ...
        <div class="page">
            <nav class="menu flex flex-justify-space-between">
                ...
                <?php if (is_authenticated()) : ?>
                    <!-- Este "li" só será exibido caso eu tenha utenticado -->
                    <li>
                ...
                <?php endif; ?>
                    <li>
                <?php if (is_authenticated()) : ?>
                        <!-- Este hyperlink só será exibido caso eu tenha autenticado -->
                        <a class="user-login-button" href="?route=logout">Fazer Logout</a>
                <?php else : ?>
                        <!-- Este hyperlink só será exibido caso eu não tenha autenticado -->
